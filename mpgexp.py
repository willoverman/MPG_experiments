...
def visit_dist(state, policy, gamma, T):
	...
	for states in state_visits:
		state_visits[state] /= T
...
def policy_gradient(max_iters, gamma, eta):
	joint_policy = {}
	for i in range(2):
	...
	for i in range(max_iters):
		print(i)
		dist0 = visit_dist(0, policy, gamma, 100)
		dist1 = visit_dist(1, policy, gamma, 100)

		dist = {}
		for key in dist0:
			dist[key] = (dist0[key] + dist1[key]) / 2
...
print(policy_gradient(500,.99, .0001))
