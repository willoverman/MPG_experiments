...
def policy_gradient(mu, max_iters, gamma, eta, T, samples, epsilon):
    policy = {}
    policy_star_1 = {(0, 0): np.array([1., 0.]), (0, 1): np.array([0., 1.]), (1, 0): np.array([0., 1.]), (1, 1): np.array([0., 1.])}
    policy_star_2 = {(0, 0): np.array([1., 0.]), (0, 1): np.array([0., 1.]), (1, 0): np.array([1., 0.]), (1, 1): np.array([1., 0.])}
    policy_star_3 = {(0, 0): np.array([0., 1.]), (0, 1): np.array([1., 0.]), (1, 0): np.array([0., 1.]), (1, 1): np.array([0., 1.])}
    policy_star_4 = {(0, 0): np.array([0., 1.]), (0, 1): np.array([1., 0.]), (1, 0): np.array([1., 0.]), (1, 1): np.array([1., 0.])}
    v_star_1 = value_function(policy_star_1,gamma,T)
    v_star_2 = value_function(policy_star_2,gamma,T)    
    v_star_3 = value_function(policy_star_3,gamma,T)
    v_star_4 = value_function(policy_star_4,gamma,T)    
    ...
    for t in range(max_iters):
        ...
        m_ca = min(current_accuracy(mu,v_pi,v_star_1,gamma,T),current_accuracy(mu,v_pi,v_star_2,gamma,T),current_accuracy(mu,v_pi,v_star_3,gamma,T),current_accuracy(mu,v_pi,v_star_4,gamma,T))
        ca.append(m_ca)
        if ca[t] < epsilon:
            iter = t
            break
